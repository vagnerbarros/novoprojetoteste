...
<body>
	...
	<%
	List<Usuario> pendentes = Fachada.getInstance().cadastroUsuario().listarPorEmpresaInativos(funcionario.getEmpresa());
	%>
					...
					<tbody>
						...
						<%for (Usuario usuario : pendentes){ %>
							<tr>
								...
								<td align="center"> <a href="controlador?acao=mudar_status&id=<%=usuario.getId() %>&pagina=a"> <img alt="" src="css/img/icons/icon_on.png" height="16"/> </a> </td>
							</tr>
						<%} %>
