...
public class DialogIncluirTipoDeAtendimento extends JDialog implements ActionListener{
	...
	private void initComponents(){
		...
		btnIncluir.setIcon(new ImageIcon(DialogIncluirTipoDeAtendimento.class.getResource("/masterfila/desktop/view/img/ok.png")));
		
		btnCancelar = new JButton("  Cancelar");
		btnCancelar.addActionListener(this);
		btnCancelar.setIcon(new ImageIcon(DialogIncluirTipoDeAtendimento.class.getResource("/masterfila/desktop/view/img/cancel.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(DialogIncluirTipoDeAtendimento.class.getResource("/masterfila/desktop/view/img/tipo.png")));
		
		JLabel lblBoxDeAtendimento = new JLabel("Incluir Tipo de Atendimento");
